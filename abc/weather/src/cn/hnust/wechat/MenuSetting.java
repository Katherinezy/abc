...
public class MenuSetting {
	...
	public static String appId = "wxfd48adebd79b0fe9";
    public static String appSecret= "12df1a95eda79161a9af1ed643524a1c"; 
    ...
    public static void add() throws JSONException{
        ...
        String json = "{"
                ...
                + "\"type\":\"view\","
                + "\"name\":\"开始答题\","
                + "\"url\":\"http://khd7ut.natappfree.cc/weather/qa.html\""
                + "}]"
        		+ "},"
        		+ "{"
        		+ "\"name\":\"我的排名\","
